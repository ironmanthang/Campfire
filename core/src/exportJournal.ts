// Shared journal export helpers. Originally in
// mobile/src/lib/exportJournal.ts; moved here so both platforms can
// produce identical files. The desktop Rust exporter (in
// src-tauri/src/commands/journal/crud.rs) writes the same format, so
// round-trips between desktop and mobile work unchanged.
