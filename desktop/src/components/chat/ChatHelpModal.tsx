      ...
      >
        ...
        <div className="p-5 border-b border-border-brand/60 flex items-center justify-between bg-bg-surface">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-text-primary text-lg">{t("chatView.helpModal.title")}</h3>
              <p className="text-xs text-text-secondary">{t("chatView.helpModal.subtitle")}</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            title={t("chatView.helpModal.closeTooltip")}
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-sm text-text-primary">
          <div className="bg-accent-brand/5 border border-accent-brand/20 p-4 rounded-xl space-y-1">
            <span className="text-xs font-bold text-accent-brand uppercase tracking-wider">
              {t("chatView.helpModal.howChatWorksTitle")}
            </span>
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-text-primary border-b border-border-brand/40 pb-1.5">
              {t("chatView.helpModal.bestPracticesTitle")}
            </h4>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="bg-bg-app/40 p-4 rounded-xl border border-border-brand/40 space-y-1.5">
                ...
                <p className="text-xs text-text-secondary leading-relaxed font-normal">
                  {t("chatView.helpModal.rule1Desc")}
                </p>
              </div>
              ...
              <div className="bg-bg-app/40 p-4 rounded-xl border border-border-brand/40 space-y-1.5">
                ...
                <p className="text-xs text-text-secondary leading-relaxed font-normal">
                  {t("chatView.helpModal.rule2Desc")}
                </p>
              </div>
              ...
              <div className="bg-bg-app/40 p-4 rounded-xl border border-border-brand/40 space-y-1.5">
                ...
                <p className="text-xs text-text-secondary leading-relaxed font-normal">
                  {t("chatView.helpModal.rule3Desc")}
                </p>
              </div>
              ...
              <div className="bg-bg-app/40 p-4 rounded-xl border border-border-brand/40 space-y-1.5">
                ...
                <p className="text-xs text-text-secondary leading-relaxed font-normal">
                  {t("chatView.helpModal.rule4Desc")}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="p-3 rounded-lg border border-green-500/20 bg-green-500/5 space-y-1">
                <div className="flex items-center gap-1.5 text-xs text-green-500 font-semibold">
                  <span>✅ {t("chatView.helpModal.comparisonMoreEffective")}</span>
                </div>
                <p className="text-xs text-text-secondary font-mono leading-relaxed pl-5">
                  {t("chatView.helpModal.comparisonMoreEffectiveDesc")}
                </p>
              </div>
            </div>
          </div>
